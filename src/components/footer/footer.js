    ...
    return(
        <div className='bg-black'>
            ...
            <div className='text-center p-4 end-footer-content font-lalehar'>
                 این وب سایت به صورت اختصاصی برای شرکت گسترش آلیاژ تندیس ساخته شده و کلیه حقوق مادی و معنوی ان مطعلق به شرکت فوق میباشد و هرگونه کپی برداری از ان غیر قانونی است
            </div>
        </div>
    )
}